...
csv_path = r"C:\Users\gustavo\Desktop\projeto-bd2\engenharia-de-dados-enem\enem2013\dados\MICRODADOS_ENEM_2013.csv"
output_parquet_dir = "parquet_chunks"
output_csv_path = "MICRODADOS_ENEM_2013_saida.csv"
output_parquet_path = "MICRODADOS_ENEM_2013_saida.parquet"
...
if usar_amostra:
    ...
    for chunk in leitor_chunks:
        parquet_path = os.path.join(output_parquet_dir, f"MICRODADOS_ENEM_2013_chunk_{numero_chunk}.parquet")
